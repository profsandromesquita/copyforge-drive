          ...
          <CardContent className="p-4 sm:p-6">
            <div className="flex flex-col lg:flex-row gap-6">
              ...
              <div className="flex-1 space-y-3">
                <div>
                  <p className="text-sm text-muted-foreground mb-1">Você está no Plano</p>
                  <h4 className="text-2xl font-bold text-primary">{subscription.plan.name}</h4>
                </div>
                ...
                {subscription.current_period_end && (
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span className="text-muted-foreground">
                      Renovação em <span className="font-medium text-foreground">{formatDate(subscription.current_period_end)}</span>
                    </span>
                  </div>
                )}
              ...
              <div className="flex-1 space-y-4">
                <div className="grid grid-cols-1 gap-3">
                  ...
                  {credits && (
                    <div className="flex items-center justify-between p-3 rounded-lg bg-background/50 border border-border/50">
                      ...
                      <span className="text-base font-semibold">
                        {credits.balance.toFixed(0)} de {subscription.plan.credits_per_month || 0}
                      </span>
                    </div>
                  )}
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="flex flex-col p-3 rounded-lg bg-background/50 border border-border/50">
                      <span className="text-xs text-muted-foreground mb-1">Projetos</span>
                      <span className="text-base font-semibold">
                        {subscription.projects_count} / {subscription.current_max_projects || '∞'}
                      </span>
                    </div>
                    <div className="flex flex-col p-3 rounded-lg bg-background/50 border border-border/50">
                      <span className="text-xs text-muted-foreground mb-1">Copies</span>
                      <span className="text-base font-semibold">
