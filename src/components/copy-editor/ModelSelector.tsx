...
export const ModelSelector = ({ copyType, selectedModel, onModelChange, disabled }: ModelSelectorProps) => {
            ...
            <RadioGroup value={effectiveModel} onValueChange={handleModelChange}>
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">Inteligente • 13x mais créditos</p>
                </div>
              </label>
            </RadioGroup>
          </div>
