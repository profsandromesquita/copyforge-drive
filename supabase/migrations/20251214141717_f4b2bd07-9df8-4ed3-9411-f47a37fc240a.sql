-- Atualizar change_workspace_plan para permitir super admins
...
BEGIN
  ...
  IF NOT (is_workspace_admin(auth.uid(), p_workspace_id) OR has_system_role(auth.uid(), 'super_admin')) THEN
